            ...
            <div class="container d-flex align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('shop.cat_wise', $product->category->slug) }}">{{ $product->category->name }}</a>
                    </li>
                    <li class="breadcrumb-item"><a
                            href="{{ route('shop.subcat_wise', $product->subCategory->slug) }}">{{ $product->subCategory->name }}</a>
                    </li>
                            ...
                            <div class="product-gallery product-gallery-vertical">
                                <div class="row">
                                    <figure class="product-main-image">
                                        <img id="product-zoom" src="{{ asset('uploads/product-image/' . $product->image) }}"
                                            data-zoom-image="{{ asset('uploads/product-image/' . $product->image) }}"
                                            alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        <a class="product-gallery-item active" href="#"
                                            data-image="{{ asset('uploads/product-image/' . $product->image) }}"
                                            data-zoom-image="{{ asset('uploads/product-image/' . $product->image) }}">
                                        ...
                                        @foreach ($product->subImages as $subImage)
                                            <a class="product-gallery-item " href="#"
                                                data-image="{{ asset('uploads/product-image/sub-image/' . $subImage->sub_image) }}"
                                                data-zoom-image="{{ asset('uploads/product-image/sub-image/' . $subImage->sub_image) }}">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        ...
                                        <div class="select-custom">
                                            <select name="color_id" id="size" class="form-control">
                                                <option selected value="">Select a color</option>
                                                @foreach ($product->productColor as $value)
                                                    <option value="{{ $value->id }}">{{ $value->color->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        ...
                                        <div class="select-custom">
                                            <select name="size_id" id="size" class="form-control">
                                                ...
                                                @foreach ($product->productSize as $value)
                                                    <option value="{{ $value->id }}">{{ $value->size->name }}</option>
                                                @endforeach
                                            </select>
                                        </div><!-- End .select-custom -->
                                        @error('size_id')
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <div class="details-action-wrapper">
                                            <a href="#" class="btn-product btn-wishlist" title="Wishlist"><span>Add
                                                    to Wishlist</span></a>
                                            <a href="#" class="btn-product btn-compare" title="Compare"><span>Add
                                                    to Compare</span></a>
                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                <span class="product-label label-new">{{ $relatedProduct->tag_title }}</span>
                                <a href="product.html">
                                    <img src="{{ asset('uploads/product-image/' . $relatedProduct->image) }}"
                            ...
                            <div class="product-body">
                                <div class="product-cat">
                                    <a href="#">{{ $relatedProduct->subCategory->name }}</a>
                                </div><!-- End .product-cat -->
                                <h3 class="product-title"><a href="product.html">{{ $relatedProduct->name }}</a></h3>
                                <!-- End .product-title -->
                                <div class="product-price">
                                    {{ $relatedProduct->regular_price }} Tk
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                                    <div class="ratings">
